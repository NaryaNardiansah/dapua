...
<div class="luxury-product-form-page">
        ...
        <div class="hero-content">
            <div class="hero-title-container">
                ...
                <p class="hero-subtitle fade-in-up delay-300">
                    ...
                    @else
                        Buat produk baru untuk Dapur Sakura
                    @endif
                </p>
            </div>
    ...
    <div class="action-buttons-section flex flex-wrap gap-4 mt-8 fade-in-up delay-200" data-aos="fade-up">
        ...
        @if(isset($product))
            <a href="{{ route('admin.products.show', $product) }}" class="action-btn info">
                            ...
                            <div class="select-wrapper">
                                <select name="category_id" class="form-select" required>
                                    ...
                                    @foreach($categories as $id => $name)
                                        <option value="{{ $id }}" 
                                                @selected(old('category_id', isset($product) ? $product->category_id : null) == $id)>
                                            {{ $name }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="textarea-wrapper">
                            <textarea name="short_description" 
                                      ...
                                      class="form-textarea">{{ old('short_description', isset($product) ? $product->short_description : '') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input name="tags_input" 
                                   value="{{ old('tags_input', isset($product) && is_array($product->tags) ? implode(', ', $product->tags) : '') }}" 
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="number" 
                                       name="sort_order" 
                                       value="{{ old('sort_order', isset($product) ? $product->sort_order : 0) }}" 
                                       min="0" 
                                       class="form-input" />
                        ...
                        <div class="status-grid">
                            <label class="status-option">
                                <input type="checkbox" 
                                       name="is_active" 
                                       value="1" 
                                       {{ old('is_active', isset($product) ? $product->is_active : false) ? 'checked' : '' }} 
                            ...
                            <label class="status-option">
                                <input type="checkbox" 
                                       name="is_new" 
                                       value="1" 
                                       {{ old('is_new', isset($product) ? $product->is_new : false) ? 'checked' : '' }} 
                                       class="status-checkbox" />
                                <div class="status-content">

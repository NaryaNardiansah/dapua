...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            .particle:nth-child(6) { top: 60%; right: 15%; animation-delay: 2.5s; }
            ...
            .decoration-line:nth-child(1) { top: 20%; left: 15%; animation-delay: 0s; }
            .decoration-line:nth-child(2) { top: 40%; right: 20%; animation-delay: 1s; }
            .decoration-line:nth-child(3) { bottom: 30%; left: 25%; animation-delay: 2s; }
            ...
            @media (max-width: 768px) {
                ...
                .logo-inner { width: 70px; height: 70px; }
	...
	<body class="font-sans antialiased bg-brand-50">
		...
		<div id="page-transition" class="fixed inset-0 bg-white/70 backdrop-blur hidden opacity-0 transition-opacity duration-500 z-50"></div>

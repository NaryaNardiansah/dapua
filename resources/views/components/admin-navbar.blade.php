            ...
            <ul class="nav-list">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="{{ route('admin.products.analytics') }}" class="dropdown-link">
                            <i class="fas fa-chart-bar"></i>Analytics
                        </a></li>
                        <li><a href="{{ route('admin.products.export') }}" class="dropdown-link">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="{{ route('admin.categories.analytics') }}" class="dropdown-link">
                            <i class="fas fa-chart-bar"></i>Analytics
                        </a></li>
